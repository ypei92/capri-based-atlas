...
%% Title information
\title[Short Title]{Capri-Based ATLAS, automatically pruning search space in auto-tuning}         %% [Short Title] is optional;
...
\par  
ATLAS uses orthogonal line search to try parameters in a limited space. 
...
\begin{acks}                            %% acks environment is optional
  ...
  like to thank Swarnendu(UTCS), Xin Sui(Tableau Software) for the Capri
  development and all the ATLAS developers.

  Yan Pei: I really enjoy this class. The course proves again that reading
  paper with discussion is a great method to learn. I learned a lot
